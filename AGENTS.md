...
- `/run/secrets/MSF_KEY` содержит сериализованный Ed25519 seed/private key; при наличии этого секрета отправка push включается автоматически и из него derivation `X-Node-Public-Key`.
